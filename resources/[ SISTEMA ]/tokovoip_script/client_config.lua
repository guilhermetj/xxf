TokoVoipConfig = {
	...
	distance = {
		...
		35, -- Shout speech distance in gta distance units
	},
	...
	plugin_data = {
		...
		TSChannel = "[Jogando]",
		TSPassword = "Zxml12", -- TeamSpeak channel password (can be empty)
		...
		TSServer = "InsideCity", -- TeamSpeak server address to be displayed on blocking screen
		...
		localNamePrefix = "[INSIDE] ", -- If set, this prefix will be added to the user's teamspeak display name
	}
};
