    ...
    window.addEventListener('message', function(event) {
        ...
        if(item.updateBarberShop){
            ...
            for (var i = 0; i <= item.drawable; i++) {           
                $("#listagem").append(`
                    <div class="lista" data-id="${i}" onclick="select(this)" id="${dataPart}${i}" style="background-image: url('http://192.168.1.3/barber/${dataPart}/${item.prefix}/${i}.jpg'); background-size: 160px 160px;">
