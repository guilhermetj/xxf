...
-----------------------------------------------------------------------------------------------------------------------------------------
local collect = {
	{ 265.83,213.99,106.29,249.16 },
	{ 265.5,212.95,106.29,246.4 },
	{ 265.05,211.92,106.29,243.3 },
	{ 264.8,211.07,106.29,237.53 },
	{ 264.45,210.1,106.29,233.83 },
	{ 238.34,215.97,106.29,298.04 },
	{ 237.84,216.93,106.29,289.2 },
	{ 237.44,217.81,106.29,291.94 },
	{ 236.93,218.65,106.29,300.16 },
	{ 236.46,219.65,106.29,286.21 },
	{ 232.34,218.8,110.29,72.74 }
...
function cnVRP.toggleService()
	if inService then
		...
		if distance <= 15 then
			...
			makeBlipMarked()
			TriggerEvent("Notify","verde","Você iniciou o emprego de <b>Transportador de Valores</b>.",3000)
		end
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
