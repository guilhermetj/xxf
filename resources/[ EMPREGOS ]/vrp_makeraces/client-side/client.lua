		...
		if IsPedInAnyVehicle(ped) then
			if inRace then
				...
				if distance <= 200 then
					timeDistance = 4
					DrawMarker(1,races[raceSelect][checkPoint][1],races[raceSelect][checkPoint][2],races[raceSelect][checkPoint][3]-3,0,0,0,0,0,0,12.0,12.0,8.0,255,255,255,150,0,0,0,0)
