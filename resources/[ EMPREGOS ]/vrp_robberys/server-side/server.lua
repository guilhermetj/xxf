...
local vars = {
	[1] = {
		...
		["required"] = "bluecard",
		["itens"] = {
			{ ["item"] = "dollars2", ["min"] = 100000, ["max"] = 130000 }
		}
	},
	[2] = {
		["x"] = 2548.883,
	...
	[20] = {
		...
		["itens"] = {
			...
			{ ["item"] = "dollars2", ["min"] = 50000, ["max"] = 75000 }
	...
	[37] = {
		...
		["required"] = "bluecard",
		["itens"] = {
			{ ["item"] = "dollars2", ["min"] = 35000, ["max"] = 50000 }
		}
	},
	[38] = {
		["x"] = -1284.667,
	...
	[43] = {
		...
		["required"] = "blackcard",
		["itens"] = {
			{ ["item"] = "goldbar", ["min"] = 1500, ["max"] = 2000 }
		}
	},
	[44] = {
		["x"] = -104.386,  
...
function cnVRP.checkPolice(robberyId,coords)
	...
	if user_id then
		if robberyProgress[vars[robberyId].type] ~= nil then
			TriggerClientEvent("Notify",source,"roxo","Aguarde <b>"..robberyProgress[vars[robberyId].type].."</b> segundos.",5000)
			return false
		end
