...
-----------------------------------------------------------------------------------------------------------------------------------------
-- STARTMACHINE         ----------   ATMS Q COLOCA C4 E EXPLODEM
-----------------------------------------------------------------------------------------------------------------------------------------
...
function cnVRP.stopMachine(x,y,z)
	...
	if user_id then
		if machineStart then
			...
			TriggerEvent("vrp_itemdrop:Create","dollars2",parseInt(math.random(35000,45000)),x,y,z,source)

			local random = math.random(100)
			if parseInt(random) >= 75 then
				TriggerEvent("vrp_itemdrop:Create","aluminum",parseInt(math.random(40,60)),x,y,z,source)
			elseif parseInt(random) >= 50 and parseInt(random) <= 74 then
				TriggerEvent("vrp_itemdrop:Create","rubber",parseInt(math.random(35,50)),x,y,z,source)
			...
			elseif parseInt(random) <= 24 then
				TriggerEvent("vrp_itemdrop:Create","copper",parseInt(math.random(10,40)),x,y,z,source)
			end
		end
	end
end
