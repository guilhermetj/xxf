...
local animacoes = {
	...
	["empolgado"] = { dict = "amb@world_human_cheering@female_a" , anim = "base" , andar = false , loop = true },
	["corridinha2"] = { dict = "amb@world_human_jog@female@base" , anim = "base" , andar = false , loop = true },
	["corridinha3"] = { dict = "amb@world_human_power_walker@female@base" , anim = "base" , andar = false, loop = true },
	["dor1"] = { dict = "misstrevor3_beatup" , anim = "guard_beatup_exit_dockworker" , andar = false , loop = true },
	["dor2"] = { dict = "combat@damage@writheidle_c" , anim = "writhe_idle_g" , andar = false , loop = false },
	["no"] = {dict = "mp_player_int_upper_nod" , anim = "mp_player_int_nod_no" , andar = true , loop = true },
	["bixa"] = { anim = "WORLD_HUMAN_PROSTITUTE_LOW_CLASS" },
	["frio"] ={ dict = "misschinese1leadinoutchi_1_mcs_4" , anim = "chi_1_mcs_4_translator_idle_2" , andar = false , loop = true },
	["nervouser"] = { dict = "rcmme_tracey1" , anim = "nervous_loop" , andar = false , loop = true },
	["taichi"] = { dict = "switch@trevor@rand_temple" , anim = "tai_chi_trevor" , andar = false , loop = false },
	["peidar"] = { dict = "rcm_barry2" , anim = "clown_idle_2" , andar = false , loop = false },
	["estralar"] = { dict = "anim@mp_player_intupperknuckle_crunch" , anim = "idle_a" , andar = false , loop = false },
	["rejeitar"] = { dict = "mini@hookers_sp" , anim = "idle_reject" , andar = true , loop = false },
	...
	["dancar274"] = { dict  = "anim@amb@nightclub@mini@dance@dance_solo@female@var_b@" , anim = "low_right_down" , andar = false , loop = true },
	...
	["sexo5"] = { dict = "oddjobs@towing" , anim = "f_blow_job_loop" , andar = false , loop = true , carros = true },
	["sexo6"] = { dict = "mini@prostitutes@sexlow_veh" , anim = "low_car_sex_loop_female" , andar = false , loop = true , carros = true },
	["sexo7"] = { dict = "misscarsteal2pimpsex" , anim = "pimpsex_hooker" , andar = false , loop = true }, -- BOQUETE DAR
	["poledance1"] = { dict = "mini@strip_club@pole_dance@pole_dance1",anim = "pd_dance_01"},
	["poledance2"] = { dict = "mini@strip_club@pole_dance@pole_dance2",anim = "pd_dance_02"},
	["poledance3"] = { dict = "mini@strip_club@pole_dance@pole_dance3",anim = "pd_dance_03"},
	...
	["Hospitalls"] = { dict = "amb@world_human_sunbathe@male@back@idle_a" , anim = "idle_a" , andar = false , loop = true , extra = function()
		local ped = PlayerPedId()
		local x,y,z = table.unpack(GetEntityCoords(ped))
		for k,v in pairs(beds) do
			local object = GetClosestObjectOfType(x,y,z,0.9,v[1],0,0,0)
