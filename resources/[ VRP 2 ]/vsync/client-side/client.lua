...
Citizen.CreateThread(function()
    TriggerEvent('chat:addSuggestion', '/clima', 'Trocar o clima.', {{ name="weatherType", help="Available types: extrasunny, clear, neutral, smog, foggy, overcast, clouds, clearing, rain, thunder, snow, blizzard, snowlight, xmas & halloween"}})
    TriggerEvent('chat:addSuggestion', '/time', 'Trocar o horário.', {{ name="hours", help="A number between 0 - 23"}, { name="minutes", help="A number between 0 - 59"}})
    TriggerEvent('chat:addSuggestion', '/travartime', 'Congelar / Descongelar o horário.')
    TriggerEvent('chat:addSuggestion', '/travarclima', 'Ativa / Desativa a mudança de clima.')
