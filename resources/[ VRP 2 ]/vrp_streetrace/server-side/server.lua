...
function cnVRP.startRace()
	...
	for k,v in pairs(copAmount) do
		async(function()
			TriggerClientEvent("Notify",v,"roxo","Recebemos um relato de um corredor ilegal.",5000)
		end)
	end
...
function cnVRP.paymentMethod(vehPlate)
	...
	if user_id then
		...
		vRP.giveInventoryItem(user_id,"dollars2",parseInt(math.random(15000,30000)),true)
	end
end
-----------------------------------------------------------------------------------------------------------------------------------------
-- DEFUSAR
