RegisterNetEvent("ks-character:normalSpawn")
RegisterNetEvent("ks-character:characterCreate")
...
AddEventHandler("ks-character:characterCreate",function(pedModelHash)
	doStatus = 1
	SetTimeout(1000,function()
		TriggerCreateCharacter(pedModelHash)
	end)
end)

AddEventHandler("ks-character:normalSpawn",function(firstspawn)
...
RegisterNUICallback('cDoneSave',function(data,cb)
	...
	SetEntityCoordsNoOffset(PlayerPedId(),297.04,-1204.37,38.9,true,true,true)
	...
	TriggerServerEvent("ks-character:finishedCharacter",currentCharacterMode)
end)
