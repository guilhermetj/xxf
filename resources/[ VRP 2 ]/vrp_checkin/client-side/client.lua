...
local bedsIn = {
	["Santos"] = {
		{ 1136.25,-1583.89,35.39 },
		{ 1140.13,-1585.56,36.29 },
		{ 1144.82,-1585.03,36.29 },
		{ 1149.15,-1585.09,36.29 }
	}
}
-----------------------------------------------------------------------------------------------------------------------------------------
-- THREADCHECKIN
				...
				if distance <= 3 then
					...
					if distance <= 1.5 and IsControlJustPressed(1,38) and vSERVER.checkServices() and GetEntityHealth(ped) < 200 then
						...
						if checkBusy >= #bedsIn[checkSelected] then
							TriggerEvent("Notify","roxo","Todas as macas estão ocupadas, aguarde.",5000)
						end
					end
				end
			end
